    ...
    <div class="d-flex background-primary">
        ...
        <div class="col-sm-10">
            <div class="list-group p-2 m-2">
                <a href="reporte_diario.php" class="list-group-item list-group-item-action">Reporte diario</a>
                <a href="reporte_mensual.php" class="list-group-item list-group-item-action">Reporte mensual</a>
            </div>
        </div>
    </div>
